  ...
  return (
    <div className={styles['privacy-container']}>
      ...
      <main className={styles['privacy-main']}>
        ...
        <section>
          <h2 className={styles['privacy-heading-1']}>1. Introduction</h2>
        ...
        <section>
          <h2 className={styles['privacy-heading-2']}>2. Information We Collect</h2>
          <h3 className={styles['privacy-heading-3']}>2.1 Personal Information</h3>
          ...
          <h3 className={styles['privacy-heading-3']}>2.2 Non-Personal Information</h3>
        ...
        <section>
          <h2 className={styles['privacy-heading-2']}>8. Changes to This Privacy Policy</h2>
          <p>We reserve the right to update or change our Privacy Policy at any time. Any changes will be posted on this page.</p>
        </section>

        <section>
          <h2 className={styles['privacy-heading-2']}>9. Contact Us</h2>
          <p>If you have any questions or concerns regarding this Privacy Policy, please contact us at our Contact page.</p>
        </section>
      </main>
    </div>
  );
